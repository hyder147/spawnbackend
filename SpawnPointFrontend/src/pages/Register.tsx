...
const styles: Record<string, React.CSSProperties> = {
    page: {
        ...
        padding: '2rem',
        background: 'radial-gradient(ellipse 90% 70% at 50% 0%, rgba(124,92,252,0.05) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 0% 100%, rgba(255,62,165,0.04) 0%, transparent 55%), var(--bg-base)',
    },
    card: {
        position: 'relative',
        width: '100%',
        ...
        boxShadow: '0 0 60px rgba(124,92,252,0.06), 0 0 0 1px rgba(124,92,252,0.04), 0 24px 80px rgba(0,0,0,0.7)',
        overflow: 'hidden',
    },
