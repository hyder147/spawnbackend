...
const SpawnLogo: React.FC<{ size?: number }> = ({ size = 52 }) => (
    <svg width={size} height={size} viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Inner hexagon */}
        <polygon points="26,9 41,17.5 41,34.5 26,43 11,34.5 11,17.5" fill="rgba(255,62,165,0.06)" stroke="url(#spawn-logo-gradient)" strokeWidth="1" strokeLinejoin="round" opacity="0.7" />
        {/* Lightning bolt */}
        ...
        <defs>
            <linearGradient id="spawn-logo-gradient" x1="20" y1="10" x2="34" y2="42" gradientUnits="userSpaceOnUse">
                ...
                <stop offset="55%" stopColor="#C34BFF" />
